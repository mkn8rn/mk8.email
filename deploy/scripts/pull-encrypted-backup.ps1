...
[CmdletBinding()]
param(
    [string]$Target = 'root@192.168.89.251',
    [string]$KeyPath = 'D:\keys\shitbox1\ssh\mk8email_ed25519',
    [string]$KnownHostsPath = 'D:\keys\shitbox1\known_hosts',
    [string]$Destination = 'D:\backups\shitbox1'
)
